package com.alura.literatura_challenge_literatura.Libreria;

import com.alura.literatura_challenge_literatura.Challenge2BackLiteraturaApplicationConsola;
import com.alura.literatura_challenge_literatura.config.ConsumoApiGutendex;
import com.alura.literatura_challenge_literatura.config.ConvertirDatos;
import com.alura.literatura_challenge_literatura.models.Autor;
import com.alura.literatura_challenge_literatura.models.Libro;
import com.alura.literatura_challenge_literatura.models.LibrosRespuestaApi;
import com.alura.literatura_challenge_literatura.models.records.DatosLibro;
import com.alura.literatura_challenge_literatura.repository.iAutorRepository;
import com.alura.literatura_challenge_literatura.repository.iLibroRepository;
...
public class Libreria {
    ...
    public Libreria(Challenge2BackLiteraturaApplicationConsola.iLibroRepository libroRepository, Challenge2BackLiteraturaApplicationConsola.iAutorRepository autorRepository) {
    }

    public void consumo() throws IOException, InterruptedException {
        var opcion = -1;
        while (opcion != 0){
            var menu = """
    ...
    private Libro getDatosLibro() throws IOException, InterruptedException {
    ...
    private void buscarLibroEnLaWeb() throws IOException, InterruptedException {
...
//        //BUSCAR AUTORES POR ANIO
    ...
    private class iLibroRepository {
    ...
    private class iAutorRepository {
        public List<Autor> findByCumpleaniosLessThanOrFechaFallecimientoGreaterThanEqual(int anioBuscado, int anioBuscado1) {
        }
    }